...
public:
    Response(){}
    virtual ~Response(){if(fileinfo){delete fileinfo;}/*if(Body){delete Body;}*/}
    size_t Status = 0;
    String Cookie;
    char* Body;
    String _body;
    ...
    int BodySize(){return _body.size();}
    void SetContent(const String& body, const String& ContentType_ = "text/plain"){
        ...
        */
        ...
        _body = body;
        // Body = (char*)body.c_str();
        bodySize = size;
        ContentType = ContentType_;
    }
    void SetContent(const char* body, int size, const String& ContentType_ = "text/plain"){
        resetBody();
        Body = (char*)body;
        bodySize = size;
        ContentType = ContentType_;
...
private:
    size_t ReadCount = 0;
    void resetBody(){if(Body){delete Body;Body=NULL;bodySize=0;}}
};
